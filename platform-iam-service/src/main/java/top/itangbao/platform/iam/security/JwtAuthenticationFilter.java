package top.itangbao.platform.iam.security;
...
/**
 * JWT 认证过滤器，用于解析并验证请求头中的 JWT Token
 */
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    @Autowired
    private UserDetailsServiceImpl userDetailsService; // 使用我们自己的 UserDetailsServiceImpl
